...
'''.format(D,CN,D,D,CB,D,D,VE,D) 
	...
	FB = '['+Fore.GREEN+'--'+Style.RESET_ALL+"]"+r'         FB:' +Fore.LIGHTRED_EX+"   FB/ahmed.samo.509511/"+Style.RESET_ALL+'    ['+Fore.GREEN+'--'+Style.RESET_ALL+"]"
 ...
 -@@,                <>                .@@=
  ...
  =@@,        :@@@@@@@@@@@@@@@@@@@@@= .@@:
   +@X        :@@@@@@@@@@@@@@@M@@@@@@:%@%
	...
	Banners = [B1,Fore.BLUE+B2+Style.RESET_ALL,Fore.GREEN+B3,Fore.LIGHTRED_EX+B4+Style.RESET_ALL,Fore.LIGHTCYAN_EX+B5+Style.RESET_ALL,Fore.BLUE+B6+Style.RESET_ALL,Fore.CYAN+B7+Style.RESET_ALL,B8,B9,B10,The_mat,cics_01,

	Black_mesa,chappie,SYSFIL,B11,Seclogin,prg2,PR1_w,Error_Bannr,Hllw,Com,ap,skf]
	print(random.choice(Banners))
